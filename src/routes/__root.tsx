...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Campus Connect Analytics" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@CampusConnect" },
      { name: "twitter:title", content: "Campus Connect Analytics — Track. Analyze. Grow." },
      { name: "twitter:description", content: "Student growth intelligence for modern institutions — track engagement, skills, and career readiness in one premium analytics platform." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Campus Connect Analytics",
          url: "https://campus-growth-insights.lovable.app",
          description: "Student growth intelligence platform for modern educational institutions.",
        }),
      },
      {
        type: "application/ld+json",
